...
func (s *Storage) CreateWithdrawal(orderNumber string, sum float64, userID int) error {
...
func (s *Storage) GetAllUserWithdrawals(userID int) ([]*domain.Withdrawal, error) {
...
func (s *Storage) GetUserWithdrawalsSum(userID int) (float64, error) {
	query := `
